<style>
    ...
    .estoque-carrinho a,
    .estoque-carrinho-2 button,
    .estoque-carrinho-2 a {
    ...
    .quantidade-estoque-2 button,
    .quantidade-estoque-2 a {
        width: 30px;
    }

    .estoque-carrinho button:hover,
    .estoque-carrinho a:hover,
    .estoque-carrinho-2 button:hover,
    .estoque-carrinho-2 a:hover {
        background: #201e20;
    }
