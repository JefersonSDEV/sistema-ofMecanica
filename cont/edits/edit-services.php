    ...
    try {
        ...
        if ($contar > 0) {
            while ($show = $resultado->FETCH(PDO::FETCH_OBJ)) {
                $id_serv = $show->id_serv;
                $nomeed = $show->nome_serv;
                $descricao = $show->desc_serv;
                $valorAnt = $show->valor_Ant;
                $valored = $show->valor_serv;
                $foto = $show->img_serv;
            }
        } else {
        ...
        <div class="area-upload-d1">
            <div class="box-upload">
                ...
                if (isset($_POST['enviarP'])) {
                    ...
                    if (!empty($_FILES['foto']['name'])) {
                        ...
                        if (in_array($extensao, $formatP)) {
                            ...
                            if (move_uploaded_file($temporario, $pasta . $novoNome)) {
                                ...
                                echo '<div style="width:100%; padding:10px;color:#e00404;">Erro não foi possível fazer o upload do Serviço !</div>';
                            }
                        } else {
                    ...
                    $update = "UPDATE servicos SET nome_serv=:nome,valor_serv=:valor,valor_Ant=:valorA,img_serv=:art,desc_serv=:descricao WHERE id_serv=:id";
                    try {
                        ...
                        if ($contar > 0) {
                            echo '<div style="width:100%; padding:10px;color:#02c415;">Serviço Atualizado com Sucesso :)</div>';
                            header("Refresh: 2");
                        } else {
                            echo '<div style="width:100%; padding:10px;color:#e00404;">Serviço NÃO foi Atualizado :(</div>';
                            header("Refresh");
                        }
                    } catch (PDOException $e) {
                ...
                <div class="box-produtos">
                    <div class="top-info-prod">
                        <div class="box-image-prod">
                            <img src="img/servicos/<?php echo $foto ?>" alt="<?php echo $foto ?>">
                        </div>
